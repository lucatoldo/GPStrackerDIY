...
JB.Icons = function(baseurl) {
	this.DefShadow	= { shadow: { anchor: {x:10,y:35}, url: baseurl+"shadow50.png" } };
	this.Bild				= { icon:   { anchor: {x: 6,y:31}, url: baseurl+"scenic.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	//this.MoveMarker	= { icon:   { anchor: {x: 6,y: 6}, url: baseurl+"marker.gif" } };
	this.MoveMarker	= { icon:   { anchor: {x: 6,y: 6}, url: baseurl+"marker.svg",
											scaledSize: { width: 11, height: 11, widthUnit: "px", heightUnit: "px" },
											size: { width: 11, height: 11, widthUnit: "px", heightUnit: "px" } } };
	//this.Cluster		= { icon:   { anchor: {x:16,y:16}, url: baseurl+"cluster.png" } };
	this.Cluster 		= { icon:   { anchor: {x:16,y:16}, url: baseurl+"cluster.svg",
											scaledSize: { width: 31, height: 31, widthUnit: "px", heightUnit: "px" },
											size: { width: 31, height: 31, widthUnit: "px", heightUnit: "px" } } };
	this.Streckenmarker 		= { icon:   { anchor: {x:11,y:11}, url: baseurl+"streckenmarker.svg",
											scaledSize: { width: 21, height: 21, widthUnit: "px", heightUnit: "px" },
											size: { width: 21, height: 21, widthUnit: "px", heightUnit: "px" } } };
	this.Kreis			= { icon:   { anchor: {x:38,y:38}, url: baseurl+"kreis.png" } };
	this.marker_bw	= { icon:   { anchor: {x:12,y:37}, url: baseurl+"marker-icon_bw.png" } };
	this.CL   			= { icon:   { anchor: {x:26,y:26}, url: baseurl+"current_location.svg",
											scaledSize: { width: 51, height: 51, widthUnit: "px", heightUnit: "px" },
											size: { width: 51, height: 51, widthUnit: "px", heightUnit: "px" } } };
	this.lodging		= { icon:   { anchor: {x:15,y:36}, url: baseurl+"hotel2.png" },
	//this.lodging		= { icon:   { anchor: {x:15,y:31}, url: baseurl+"hotel.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.hotel = this.lodging;
	this.museum			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"museum.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.residence	= { icon:   { anchor: {x:15,y:36}, url: baseurl+"villa.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.library		= { icon:   { anchor: {x:15,y:36}, url: baseurl+"library.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.park				= { icon:   { anchor: {x:15,y:36}, url: baseurl+"park.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.castle			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"castle.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.airport		= { icon:   { anchor: {x:15,y:36}, url: baseurl+"airport.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.church			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"church2.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.bridge			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"bridge.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.bar				= { icon:   { anchor: {x:15,y:36}, url: baseurl+"bar.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.restaurant	= { icon:   { anchor: {x:15,y:36}, url: baseurl+"restaurant.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.start			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"start.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.finish			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"finish.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.cycling		= { icon:   { anchor: {x:15,y:36}, url: baseurl+"cycling.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.hiking			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"hiking.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.flag				= { icon:   { anchor: {x:15,y:36}, url: baseurl+"flag.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.harbor			= { icon:   { anchor: {x:15,y:36}, url: baseurl+"harbor.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.anchor			= this.harbor;
	this.campground	= { icon:   { anchor: {x:15,y:36}, url: baseurl+"tent.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.summit     = { icon:   { anchor: {x:15,y:36}, url: baseurl+"peak.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.railway    = { icon:   { anchor: {x:15,y:36}, url: baseurl+"train.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this["shopping center"] = { icon:   { anchor: {x:15,y:36}, url: baseurl+"shoppingmall.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this["ground transportation"] = { icon:   { anchor: {x:15,y:36}, url: baseurl+"subway.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this["scenic area"] = { icon:   { anchor: {x:15,y:36}, url: baseurl+"photo.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this["boat ramp"]   = { icon:   { anchor: {x:15,y:36}, url: baseurl+"boat.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
	this.circle_red 		= { icon:   { anchor: {x:8,y:6}, url: baseurl+"circle_red.svg",
											scaledSize: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" },
											size: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" } } };
	this.circle_green		= { icon:   { anchor: {x:8,y:8}, url: baseurl+"circle_green.svg",
											scaledSize: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" },
											size: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" } } };
	this.square_red 		= { icon:   { anchor: {x:8,y:8}, url: baseurl+"square_red.svg",
											scaledSize: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" },
											size: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" } } };
	this.square_green		= { icon:   { anchor: {x:8,y:8}, url: baseurl+"square_green.svg",
											scaledSize: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" },
											size: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" } } };

	//this.myicon       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"myicon.png" },
	//                    shadow: { anchor: {x:10,y:31}, url: baseurl+"shadow.png" } };
